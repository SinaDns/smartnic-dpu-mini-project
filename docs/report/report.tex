...
\title{
    ...
    \begin{minipage}{\textwidth}
        \flushright \small \texttt{Seminar Project: Computer Systems \& Networks}
    \end{minipage} \\[1cm]
    \textbf{\Large SmartNICs and Data Processing Units (DPUs)} \\
    \large Bridging the Gap between Performance and Programmability
}
\author{
    \textbf{Sina Daneshgar} \& \textbf{Mohammadmohsen Abbaszadeh} \\
    \small \href{mailto:sina@example.com}{SinaDns} \& \href{mailto:mohsen@example.com}{HisEgo}
}
\date{February 2026}
