...
\begin{frame}{SmartNIC Landscape}
    ...
    \begin{itemize}
        ...
        \item Use this slide when you explain trade-offs: throughput, latency and power.
    \end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \item Point to \texttt{basic\_l2.p4} when explaining table installs and entries.
\end{itemize}
\end{frame}
...
\begin{frame}{Application 3: Line-rate Security \& DDoS Mitigation}
    \begin{itemize}
        ...
        \item \textbf{Demo hint}: start with `examples/03-ebpf-xdp` for early-drop logic; scale to DPU offloads for production.
    \end{itemize}
\end{frame}
...
\begin{frame}{Simulation: Offload Performance}
    ...
    \vspace{2mm}
    \small Model note: offloading fraction $\alpha$ of packet processing increases host capacity approximately proportionally.
    \vfill
